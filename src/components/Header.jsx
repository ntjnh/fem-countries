...
export default function Header({ isDark, modeToggle }) {
    const lightClasses = 'bg-white shadow-md shadow-neutral-200/60 text-grey-925'
    ...
    return (
        <header className={`p-7 md:py-6 ${modeClasses}`}>
            <div className="container flex items-center justify-between mx-auto">
                <h1 className="font-bold m-0 text-sm md:text-lg lg:text-2xl">Where in the world?</h1>

                <button className="text-xs md:text-sm lg:text-base" onClick={() => modeToggle()}>
